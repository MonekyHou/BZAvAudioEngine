...
class RealTimeAnalyzer:NSObject {
    ...
    public var frequencyBands: Int = 128 //频带数量
    ...
    func loadanalyse(with buffer: AVAudioPCMBuffer) -> [[Float]] {
        let channelsAmplitudes = loadfft(buffer)
    ...
    private func loadfft(_ buffer: AVAudioPCMBuffer) -> [[Float]] {
